...
function setSizes()
{
    ...
    //var size = docuWidth - (canvas.width);
    var size = docuWidth;
    ...
    $(gridBox).width(docuWidth-CANVAS_PADDING);
}
...
function initGrid(grid)
{
    ...
    grid.setInitWidths("size/13,150,size/13,size/13,size/13,size/13,size/13,size/13,size/13,size/13");
